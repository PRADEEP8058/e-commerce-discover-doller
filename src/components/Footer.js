    ...
    return (
        <div className="footer-container">
            <footer class="footer">
                ...
                <div class="row">
                        ...
                        <div class="footer-widget">
                                <h4 class="mb-4">ONLINE - SHOPPING</h4>
                                <p class="lead">This is e-comerce website using for shopping</p>
                                
                                <div class="">
                                    <p class="mb-0"><strong>Location : </strong>HBTU Kanpur ,India</p>
                                    <p><strong>Support Email : </strong> py3371328@email.com</p>
                                </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3 col-sm-6 text-center text-sm-left">
                            ...
                            <li class="d-lg-flex justify-content-between">Sundaay <span>12-20.00</span></li>
                            </ul>
            
                            <h5>Call Now : +91 8058150598</h5>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-btm py-4 ">
                ...
                <div class="row ">
                        <div class="col-lg-6">
                            <p class="copyright mb-0 ">@ Copyright Reserved to Pradeep yadav &amp; made by <br/> <a href="https://linkedin.com/in/pradeep-yadav-1313a71aa/">Pradeep Kumar Linkedin</a></p>
                        </div>
                        <div class="col-lg-6">
