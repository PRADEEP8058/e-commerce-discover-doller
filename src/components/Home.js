    ...
    return (
        <div className="home-container">
            <div className="main-slider slider slick-initialized slick-slider">
                <div class="slider-item" style={{ backgroundImage: "url('assets/images/slideshow1-3.jpg')", backgroundPosition: "50%", backgroundRepeat: "no-repeat" }}>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                                <div class="slider-caption">
                                    <span class="lead">Modern Fashionables</span>
                                    <h1 class="mt-2 mb-5"><span class="text-color">Summer </span>trending cloths</h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 offset-lg-6">
                            <div class="ads-content">
                                <span class="h5 deal">Deal of the day 40% Off</span>
                                ...
                                <a href="#" class="btn btn-main"><i class="ti-bag mr-2">Shop Now</i> </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="widget-featured-entries mt-5 mt-lg-0">
                                ...
                                <div class="media mb-3">
                                    ...
                                    <div class="media-body">
                                        <h6 class="featured-entry-title mb-0"><a href="#">Ladies-bag</a></h6>
                                        <p class="featured-entry-meta">Rs 420.99</p>
                                    </div>
                                </div>
                                ...
                                <div class="media mb-3">
                                    ...
                                    <div class="media-body">
                                        <h6 class="featured-entry-title mb-0"><a href="#">Nike - Backpack</a></h6>
                                        <p class="featured-entry-meta">Rs27.99</p>
                                    </div>
                                </div>
                                ...
                                <div class="media mb-3">
                                    ...
                                    <div class="media-body">
                                        <h6 class="featured-entry-title mb-0"><a href="#">Guess </a></h6>
                                        <p>Rs 380.00</p>
                                    </div>
                                </div>
                                ...
                                <div class="media mb-3">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="featured-entry-meta">Rs35.00</p>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="featured-entry-title mb-0"><a href="#"> Tops</a></h6>
                                        <p class="featured-entry-meta">Rs 10.60</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-featured-entries mt-5 mt-lg-0">
                                ...
                                <div class="media mb-3">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="featured-entry-meta">Rs42.99</p>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="featured-entry-meta">Rs10.60</p>
                                    </div>
                                </div>
                            </div>
                        </div>
